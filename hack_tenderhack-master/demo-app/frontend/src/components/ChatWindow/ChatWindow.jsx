            ...
            {selectedTender == null ? (
                ...
                <div style={{ overflowY: 'auto', height: '100%' }}>
                    ...
                    <MsgPos pos='0'>
                        <DocumentForm
                            data={{
                                ...
                                link: '#',
                                documents: [
                                    { name: 'приложение 1', link: '#' },
                                    { name: 'приложение 2', link: '#' },
                                ],
                            }}
                        />
                    </MsgPos>
                    ...
                    <MsgPos pos='0'>
                        <ArbitraryItemMessage
                            data={{
                                documentId: '834954',
                                item: 3,
                                proposedEdition: 'отменить поставку 10 стульев',
                                comment: 'мы не можем себе это позволить',
                            }}
                        />
                    </MsgPos>
                    ...
                    <MsgPos pos='0'>
                        <InfoMessage>
                            <Typography>
                                Ваши изменения отправлены заказчику, ожидайте
                                его решения. Уведомление также продублируется
                                вам на почту.
                            </Typography>
                        </InfoMessage>
                    </MsgPos>
                    ...
                    <MsgPos pos='0'>
                        <SuccessMessage>
                            <Typography>
                                Здравствуйте! Заказчик одобрил ваши изменения.
                            </Typography>
                        </SuccessMessage>
                    </MsgPos>
                    ...
                    <MsgPos pos='0'>
                        <ErrorMessage>
                            <Typography>
                                Здравствуйте! Заказчик отказался от ваших
                                изменений.
                            </Typography>
                        </ErrorMessage>
                    </MsgPos>
                    ...
                    <MsgPos pos='1'>
                        <CustomerEditedRedaction
                            data={{
                                idDocument: '55951981',
                                item: '10',
                                proposedRedaction: 'пермь, бульвар гагарина 35',
                                customerRedaction:
                                    'Пермский край, г. Пермь, бульвар гагарина 35',
                    ...
                    <br />
                    <MsgPos pos='1'>
                        <EditDynamicFieldForm
                            data={{ field: 'количесво стульев' }}
                        />
                    </MsgPos>
                    ...
                    <InfoMessage>
                        <Typography>
                            Ваши изменения отправлены заказчику, ожидайте его
                            решения. Уведомление также продублируется вам на
                            почту.
                        </Typography>
                    </InfoMessage>
                    ...
                    <ErrorMessage>
                        <Typography>
                            Здравствуйте! Заказчик отказался от ваших изменений.
                        </Typography>
                    </ErrorMessage>
                    ...
                    <AcceptWholeDocumentChange
                        data={{
                            ...
                            fileLink: '#',
                            fileName: 'file',
                            comment: 'посмотрите пж',
                        }}
                    />
                    {`<AcceptWholeDocumentChange />`}
                    <Pic prevDisabled={true}>
                        <img src={contractItem} />
                    </Pic>
                    <Pic>
                        <img src={customer} />
                    </Pic>
